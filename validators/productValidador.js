...
const productValidationRules = () => [
    ...
    body("brand")
        .optional({ nullable: true })
        .isString().withMessage("A marca deve ser um texto.")
        .isLength({ max: 255 }).withMessage("A marca deve ter no máximo 255 caracteres."),

    body("ean")
        .optional({ nullable: true })
        .isInt().withMessage("O EAN deve ser um número inteiro.")
