...
router.post(
    ...
    async (req, res, next) => {
        ...
        try {
            ...
            // 4. Inserir o novo usuário na tabela 'usuarios'
            const newUserQuery = `
            ...
            const roleResult = await client.query("SELECT id FROM roles WHERE nome = 'user'");
            ...
            const userRoleQuery = `
                ...
                VALUES ($1, $2)`;
            await client.query(userRoleQuery, [newUserId, userRoleId]);
